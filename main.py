...
#Maybe this def can be done with StandardScaler
...
def main():
    ...
    with st.container():
        ...
        st.write('Please connect this app to your cytology lab to help diagnose breast cancer from your tissue sample. This app predicts using Machine Learning model whether a breast mass is benign or malignant based on the measurements it reaceives from your cytosis lab.')
